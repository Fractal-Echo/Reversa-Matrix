...
<head>
  ...
  <title>Reversa-Matrix Compare Report</title>
  <style>
    ...
    .report-hero { display: grid; grid-template-columns: minmax(0, 1fr) minmax(320px, 520px); gap: 28px; align-items: center; }
    .tagline { color: #6ee7b7; font-weight: 700; }
    .console-panel {
    ...
    .console-title { fill: #f8fafc; font: 800 25px system-ui, sans-serif; letter-spacing: 0; }
    .console-subtitle { fill: #b6c2c0; font: 500 12px system-ui, sans-serif; letter-spacing: .08em; text-transform: uppercase; }
    ...
    .console-label { fill: #f8fafc; font: 700 12px system-ui, sans-serif; }
...
<body>
  <header>
    <div class="report-hero">
      <div>
        <h1>Reversa-Matrix Compare Report</h1>
        <p>${escapeHtml(report.compare.left_root)} -> ${escapeHtml(report.compare.right_root)}</p>
        <p class="tagline">Reverse-engineering evidence mapper for source trees, contradictions, and analysis.</p>
      </div>
      ${compareConsoleMarkup()}
    </div>
  </header>
  <main>
...
function compareConsoleMarkup() {
  return `<div class="console-panel" aria-label="Reversa-Matrix compare routing diagram">
    <svg viewBox="0 0 520 300" role="img">
      <title>Reversa-Matrix compare routing</title>
      ...
      <text class="console-subtitle" x="44" y="78">Tree compare / evidence routing / import review</text>
      <path class="console-route route-evidence" d="M92 178 C150 118 216 118 282 158"/>
      ...
      <circle class="console-node" cx="92" cy="178" r="28"/>
      ...
      <text class="console-label" x="66" y="218">left tree</text>
      <text class="console-label" x="248" y="202">diffs</text>
      <text class="console-label" x="390" y="158">right tree</text>
      <text class="console-label" x="400" y="252">import review</text>
    </svg>
  </div>`;
}
