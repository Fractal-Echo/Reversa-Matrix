...
const AGENT_LABELS = {
  ...
  'reversa-agents-help':      'Agents Help: explains available agents',
  ...
  'reversa-paradigm-advisor': 'Paradigm Advisor: detects paradigm gaps between source and target stacks',
  ...
  'reversa-screen-translator': 'Screen Translator: translates screens into executable specs and emits golden files',
