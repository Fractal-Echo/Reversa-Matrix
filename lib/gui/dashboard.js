...
.hero-inner { display: grid; grid-template-columns: minmax(0, 1.25fr) minmax(320px, .75fr); gap: 24px; align-items: center; }
.console-panel {
  border: 1px solid rgba(64,216,143,.38);
  border-radius: 8px;
  background:
    linear-gradient(rgba(64,216,143,.07) 1px, transparent 1px),
    linear-gradient(90deg, rgba(64,216,143,.07) 1px, transparent 1px),
    #08110f;
...
.console-node { fill: #0d1f18; stroke: var(--accent); stroke-width: 2; }
